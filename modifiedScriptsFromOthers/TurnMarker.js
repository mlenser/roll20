			...
			if(state.TurnMarker.announceRounds)
			{
				sendChat(
                  ...
                  +'<div class="sheet-rt-card">'
                    +'<div class="sheet-rt-header" style="background-color: #4b0082">'
                      +'<div class="sheet-rt-title">'
                        +'<div class="sheet-row">'
                          +'<div class="sheet-col-1-4 sheet-center sheet-vert-middle sheet-pad-r-sm">'
                            +'<img src="'+state.TurnMarker.tokenURL+'" style="width:23px; height:23px;">'
                          +'</div>'
                          +'<div class="sheet-col-1-2 sheet-center sheet-vert-middle">'
                            +"Round "+ round
                          +'</div>'
                          +'<div class="sheet-col-1-4 sheet-center sheet-vert-middle sheet-pad-l-sm"">'
                            +'<img src="'+state.TurnMarker.tokenURL+'" style="width:23px; height:23px;">'
                          +'</div>'
                        +'</div>'
                      +'</div>'
		...
		_HandleAnnounceTurnChange: function(){
			...
			if(state.TurnMarker.announceTurnChange )
			{
				...
				if(currentToken && currentToken.get('showplayers_name')) {
					cNameString='<span>' +currentToken.get("name") +'\'s turn!</span>';
				}
