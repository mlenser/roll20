    ...
    handleAnnounceTurnChange = function () {
      ...
      if (state.TurnMarker.announceTurnChange) {
        ...
        sendChat(
          '',
          "/direct " +
          "<div style='border: 3px solid #808080; background-color: #4b0082; color: white; padding: 1px 1px; border-radius: 3px;'>" +
          '<div style="margin: 2px; position: relative; vertical-align: text-bottom;">' +
